...
const AllDelivery = () => {
    ...
    const axiosPublic = useAxiosPublic(); // Use the custom hook
    ...
    const makeUser = async (userId) => {
        try {
            const response = await axiosPublic.patch(`/users/${userId}`, { userType: 'user' });
                ...
                <div className=''>
                    <div className='w-72 h-screen bg-[#a3cac9] shadow-2xl pt-14 flex flex-col justify-evenly'>
                        <div>
                            ...
                            <div className='pb-10'>
                                <h1 className='text-center text-xl font-bold'>
                                    <Link className='border-2 p-2 rounded-xl bg-white text-[#a3cac9]' to="/dashboard/alldelivery">All Delivery Men</Link>
                                </h1>
                            </div>
                            <div>
                                <h1 className='text-center text-xl font-bold'>
                                        ...
                                        {userData.map((user, index) => (
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    ...
                                                    <button onClick={() => makeUser(user._id)} className='btn bg-fuchsia-500 hover:bg-fuchsia-400 text-white'>User</button>
